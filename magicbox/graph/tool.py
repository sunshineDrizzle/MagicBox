...
def bfs(edge_list, start, end, deep_limit=np.inf):
    ...
    edge_list : dict | list
        ...
        One index's corresponding element is a collection of vertices which
    ...
    deep_limit : integer
        ...
        If the search depth reach the limitation without finding
            the end vertex, it returns False.
